...
* [`src/social/`](src/social/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/social/core.cljs): contains the SPA entry point, `init`
* [`test/social/`](test/social/): test files (ClojureScript,
...
5. Clone this repo and open a terminal in the `social` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/social/config.cljs) defaults to `true` in
...
```clj
(ns social.example
  (:require [social.config :as config])
